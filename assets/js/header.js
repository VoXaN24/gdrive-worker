...
document.getElementById('computer-menu').innerHTML = '<div class="ui container"><a href="/" class="' + homeClassList + '"><i class="home icon"></i>Home</a><div class="right menu"><a id="darkmode-button2" onclick="toggleDarkmode();" class="item"></a><a href="' + discordInvite + '" class="item"><i class="discord icon"></i>Discord</a><a href="https://gitlab.com/VoXaN24/gdrive-worker" class="item"><i class="github icon"></i>GitHub</a></div></div>';
document.getElementById('sidebar').innerHTML = '<a href="/" class="' + homeClassList + '"><i class="home icon"></i>Home</a><a id="darkmode-button1" onclick="toggleDarkmode();" class="item"></a><a href="' + discordInvite + '" class="item"><i class="discord icon"></i>Discord</a><a href="https://gitlab.com/VoXaN24/gdrive-worker" class="item"><i class="github icon"></i>GitHub</a>';
